  ...
  <div class="app-container">
    <el-card>
      <div class="search-bar">
        ...
        <el-button type="primary" :icon="Check" @click="handleSave" style="margin-left:8px" :disabled="tableData.length===0">保存报损</el-button>
      </div>
      ...
      <el-table :data="tableData" border stripe>
        ...
        <el-table-column label="报损数量" width="140"><template #default="{ row }"><el-input-number v-model="row.goodsNum" :min="1" size="small" /></template></el-table-column>
...
import { listGoods, saveDamage } from '../../api'
...
const handleSave = async () => { await saveDamage({ remarks: form.value.remarks, goodsList: tableData.value }); ElMessage.success('报损成功'); tableData.value = []; form.value = {} }
onMounted(loadGoods)
</script>
