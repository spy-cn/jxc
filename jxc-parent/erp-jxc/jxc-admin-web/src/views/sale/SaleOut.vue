  ...
  <div class="app-container">
    <el-card>
      <div class="search-bar">
        ...
        <el-button type="primary" :icon="Check" @click="handleSave" style="margin-left:8px" :disabled="!form.customerId || tableData.length===0">保存出库</el-button>
      </div>
...
import { listCustomer, listGoods, saveSale } from '../../api'
...
const handleSave = async () => { await saveSale({ customerId: form.value.customerId, remarks: form.value.remarks, goodsList: tableData.value }); ElMessage.success('销售成功'); tableData.value = []; form.value = { remarks: '' } }
