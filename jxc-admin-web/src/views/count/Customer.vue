  ...
  <div class="app-container">
    <el-card>
      ...
      <el-table :data="tableData" border stripe v-loading="loading">
        ...
        <el-table-column prop="orderCount" label="购买次数" width="100" />
...
const loadData = async () => { loading.value = true; try { const res = await countCustomer(params.value); tableData.value = res.data } finally { loading.value = false } }
onMounted(loadData)
</script>
