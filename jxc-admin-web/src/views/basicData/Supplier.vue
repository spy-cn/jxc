<template>
  <div class="app-container">
      ...
      <el-table :data="tableData" border stripe v-loading="loading">
        ...
        <el-table-column label="操作" width="150" fixed="right">
          <template #default="{ row }">
            ...
            <el-popconfirm title="确定删除吗？" @confirm="handleDelete(row.supplierId)">
    ...
    <el-dialog v-model="dialogVisible" :title="form.supplierId ? '编辑供应商' : '新增供应商'" width="500px">
...
import { listSupplier, saveSupplier, delSupplier } from '../../api'
...
const handleSave = async () => {
  if (!form.value.supplierName) { ElMessage.warning('请输入名称'); return }
